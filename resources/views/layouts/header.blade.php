        ...
        <div class="w-100 mx-auto text-neutral-800 sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
            <div class="grid items-center gap-12 lg:grid-cols-2">
                <div class="mt-12 lg:mt-0" style="z-index: 10">
                    <h1
                        class="mt-0 mb-12 text-4xl font-bold tracking-tight md:text-5xl xl:text-6xl text-[hsl(218,81%,95%)]">
                        Zero-Knowledge-Proof<br /><span class="text-indigo-700">Encrypted Messages</span>
                    </h1>
                        ...
                        <form>
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="relative mb-6" data-te-input-wrapper-init>
                                    <input type="text"
                                        class="peer block min-h-[auto] w-full rounded bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0 border-gray-300 dark:border-gray-700 focus:border-0 rounded-md shadow-sm"
                            ...
                            <div class="flex justify-center">
                                <a href="#!" role="button"
                                    class="action:text-indigo-700 dark:action:text-indigo-600 text-indigo transition duration-200 ease-in-out hover:text-indigo-600 focus:text-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-500 dark:focus:text-indigo-500">
                                    <!-- Facebook -->
