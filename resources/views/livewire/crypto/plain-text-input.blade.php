        ...
        <div class="form-group">
            <div class="mt-2">
                <textarea id="body" name="body" rows="15" cols="100"
                    class="block w-full rounded-md border-0 p-3 text-gray-300 shadow-sm ring-1 ring-inset ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 border-gray-700 bg-gray-900 focus:border-indigo-600 rounded-md shadow-sm block mt-1 w-fulll"
                    wire:model="body" required>{{ $body }}</textarea>
                <div>
                    @error('body')
                ...
                <div class="mt-2">
                    <label for="secret" class="text-xs text-white uppercase tracking-widest">Secret</label>
                ...
                <div class="mt-4">
                    ...
                    @else
                        <button name='encrypt' wire:model="encrypt"
