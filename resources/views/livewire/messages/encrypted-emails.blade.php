<div>
    ...
    @endif
    <form id="emailForm" wire:submit.prevent="encryptEmail('email')">
        <div class="form-group">
            <div class="grid grid-cols-2 gap-4 mt-2">
                <div class="">
                    <label for="recipient"
                        class="text-xs dark:text-white text-gray-800 uppercase tracking-widest">Recipient</label>
                ...
                <div class="">
                    <label for="subject"
                        class="text-xs dark:text-white text-gray-800 uppercase tracking-widest">Subject</label>
            ...
            <div class="mt-2">
                <label for="body"
                    class="text-xs dark:text-white text-gray-800 uppercase tracking-widest">Body</label>
