                            ...
                            <div class="">
                                @foreach ($encryptedEmails as $item)
                                    <div class="md:flex items-center justify-between mt-2">
                                        ...
                                        <div class="md:flex items-center text-left md:ms-2">
                                            @if ($item->created_at)
                                                <div class="text-sm text-gray-400 md:ms-6">
                                            ...
                                            <a class="cursor-pointer md:ms-6 text-sm text-red-500 md:px-3 mb-0"
                                    ...
                                    <hr class="md:hidden mt-2 mb-0" style="border-color: #595959;" />
                                @endforeach
                            </div>
                        @else
